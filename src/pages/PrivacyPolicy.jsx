      ...
      <div className="legal__container">
        ...
        <div className="legal__content">
          <div className="legal__section">
            <h2>Introduction</h2>
            <p>Welcome to {restaurantInfo.name}. We respect your privacy and are committed to protecting your personal data. This privacy policy will inform you as to how we look after your personal data when you visit our website and tell you about your privacy rights and how the law protects you.</p>
          </div>
          ...
          <div className="legal__section">
            ...
            <ul>
              ...
              <li><strong>Contact Data</strong> includes email address and telephone numbers (such as WhatsApp).</li>
          ...
          <div className="legal__section">
            ...
            <ul>
              <li>To register you as a new customer and deliver your welcome reward.</li>
          ...
          <div className="legal__section">
            ...
            <p>If you wish to request the deletion of your personal data from our systems, please contact us using the details provided below. We will process your request in accordance with applicable data protection laws.</p>
          </div>
